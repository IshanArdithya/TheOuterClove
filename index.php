...
<body>
    ...
    <div id="welcome" class="main-color1">
        <div class="heading-wrap">
            ...
            <p>Welcome to The Outer Clove, your ultimate dining destination in Sri Lanka. As the town's top restaurant,
                we're thrilled to bring you daily offers that elevate your dining experience.</p>
            <p>Whether it's a delightful breakfast, a weekend treat, or a quick bite, we've got something special for
            ...
            <div class="imagesides-column">
                ...
                <div class="imagesides-content">
                    ...
                    <p>
                        ...
                        Clove's flavors from the comfort of your home. Treat yourself to a simple and delightful dining
            ...
            <div class="imagesides-column">
                ...
                <div class="imagesides-content">
                    ...
                    <p>
                        ...
                        favorite table with just a few clicks. Whether it's a cozy dinner for two or a celebration with
                        friends, our easy online reservation system ensures your seat is ready when you are. Book now
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="feedback-card">
                        ...
                        <p class="feedback-text">"Lovely place! The roti rolls were a hit, and the biryani was full of
                ...
                <div class="swiper-slide">
                    <div class="feedback-card">
                        ...
                        <p class="feedback-text">"The chicken curry is a must-try! Flavorful and not too spicy. Plus,
                ...
                <div class="swiper-slide">
                    <div class="feedback-card">
                        ...
                        <p class="feedback-text">"Spectacular! We had an amazing tasting menu. The food was exquisite,
            ...
            <form id="feedbackform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <div class="fform-row">
                    <div class="fform-field">
                        <input type="text" id="f_name" name="f_name" placeholder="Your Name" maxlength="100" required
                            <?php echo $readonly; ?>>
                    </div>
                    <div class="fform-field">
                ...
                <div class="fform-row">
                    <div class="fform-field">
                        <input type="number" id="f_quality" name="f_quality" placeholder="Food Quality [1-5]" min="1"
                            max="5" required <?php echo $readonly; ?>>
                    </div>
                    <div class="fform-field">
                        <input type="number" id="f_service" name="f_service" placeholder="Service [1-5]" min="1" max="5"
