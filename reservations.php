            ...
            <form class="reservation-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="rform-row">
                    <div class="rform-field">
                        <input type="text" id="rname" name="rname" placeholder="Your Name" maxlength="100" required <?php echo $readonly; ?>>
                    </div>
                    <div class="rform-field">
                        <input type="email" id="remail" name="remail" placeholder="Your Email" maxlength="350" required <?php echo $readonly; ?>>
                    </div>
                </div>
        
                <div class="rform-row">
                    <div class="rform-field">
                        <input type="tel" id="rphone" name="rphone" placeholder="Your Phone" maxlength="12" required <?php echo $readonly; ?>>
                    </div>
                    <div class="rform-field">
                ...
                <button type="submit" class="rform-button" <?php echo $buttonDisabled; ?>><span></span> <?php echo $buttonText; ?></button>
                
                <div class="reservation-description">
                    <p>* Kindly book your table at least 24 hours before your desired reservation time.</p>
                    <p>* Your reservation will be either accepted or denied by us. You can check it by logging in to your account.</p>
